...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Admin') - NTS Batu</title>
...
<body class="dashboard-body">
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <div class="sidebar-brand-inner">
                ...
                <div class="sidebar-brand-text">
                    <h2>NTS Batu</h2>
                    <span>Strawberry Order Admin</span>
                </div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('products.index') }}" class="nav-item {{ ($activeNav ?? '') === 'products' ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('orders.index') }}" class="nav-item {{ ($activeNav ?? '') === 'orders' ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
